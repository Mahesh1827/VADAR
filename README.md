...
VADAR uses [SAM2](https://github.com/facebookresearch/sam2), [Depth Pro](https://github.com/apple/ml-depth-pro) and [Florence-2](https://huggingface.co/microsoft/Florence-2-large).
